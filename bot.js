...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Desert Bot- Script By : AG Clan`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : AG Clan ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`#bc |AG_Team`,"http://twitch.tv/Death Shop")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "invite")) {
        let invite = new Discord.RichEmbed()
            ...
            .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=644779662043774978&permissions=0&scope=bot`);
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            رابط سيرفر الدعم الفني : https://discord.gg/mJXFwhn
            **`);
